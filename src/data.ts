...
export const SKILLS: SkillGroup[] = [
  ...
  },
  {
    ...
    items: ["React.js", "Next.js", "Redux Toolkit", "RTK Query", "SPFx"],
  },
  {
    label: "// ui & styling",
    items: [
  ...
  {
    label: "// auth & security",
    items: ["Azure AD (SSO)", "MSAL React", "RBAC"],
  },
  {
    label: "// tools",
    items: ["Git", "Azure DevOps", "Agile/Scrum", "Webpack/Vite"],
  },
];
...
export const TERMINAL_LINES: { text: string; granted?: boolean }[] = [
  ...
  {
    text: "&gt; role &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>Frontend Engineer</b>",
  },
  ...
  {
    text: "&gt; status &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ACCESS GRANTED — open to new roles",
    granted: true,
  },
];
